...
1. What are the various element of JSP page?
...
2. Why session management is required in JSP?
...
3. Write a JSP scriptlet for displaying even numbers between 1 to 50and also its JSTL version.
Ans:
...
4. List and elaborate any five JSP implicit objects with examples.
Ans:
...
5. Write JSP code to accept product details and store in database table. If the product is already inserted, display the appropriate message to insert another product. (Assume suitable table structures).
Ans:
...
6. Write advantages of JSP over Servlets? Also explain life cycle of aJSP.
...
7. List and elaborate any five JSP actions with example.
...
8. Explain HTTP request and response messages used in JSP.
...
9. Create a JSP page to search a student details from database by studentId. (Assume suitable table structure).
...
10. What are JSP actions? Explain error handling in JSP using JSP actions with example.
Ans: JSP actions are special XML tags that are used to perform specific tasks in a JSP page. Some common JSP actions are:
    - include: The include action is used to include the content of another resource in the current JSP page. For example, `<jsp:include page="header.jsp" />` includes the content of the header.jsp file in the current JSP page.
    - forward: The forward action is used to forward the request to another resource. For example, `<jsp:forward page="error.jsp" />` forwards the request to the error.jsp file.
    - useBean: The useBean action is used to create or retrieve a JavaBean object in a JSP page. For example, `<jsp:useBean id="user" class="com.example.User" scope="session" />` creates a User object and stores it in the session scope with the id "user".
...
11. What is use of isThreadSafe in JSP? Also Explain Single Thread Model in JSP.
...
13. Write a jsp code which adds the student education details in a database through Java bean.
...
14. What are the usage of JSP Directives and JSP Actions.
...
15. Write the different usage of JSP action tags and directives.
...
16. Create simple JSP pages which will explain use implicit session object of JSP.
...
17. Write JSP code for accepting product-id from user. Verify if product already exists the
Ans: JSP code to accept product-id from the user and verify if the product already exists:
        ...
        %>
        ```
18. What is difference between include action and include directive in JSP?
...
19. How do you define application wide error page in JSP?
...
20. What is the use of JSP useBean action?

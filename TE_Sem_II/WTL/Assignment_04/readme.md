...
4. What are the different ways to include JavaScript in an HTML document?
...
6. What are JavaScript closures? Provide an example.
...
10. What are arrow functions in JavaScript? Provide an example.
...
13. What are promises in JavaScript? How do they work?
...
14. What is the event loop in JavaScript? How does it work?
...
15. What is the purpose of the `fetch` API in JavaScript? How does it work?
...
16. What is JSON? How is it related to JavaScript?
...
17. What are JavaScript modules? How do they work?
...
18. What is the difference between `setTimeout` and `setInterval` in JavaScript?
